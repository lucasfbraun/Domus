...
- Guarded by `tests/Feature/ThemeColorsTest.php` and `.cursor/rules/brand-colors.mdc`
...
Every media-capable model must register a WebP conversion with optimization via the concern helper (or equivalent):
