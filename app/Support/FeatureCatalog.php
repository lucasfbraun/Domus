    ...
    private static function entries(): array
    {
        return [
            ...
            [
                ...
                'tests' => [],
                'note' => 'Só a listagem é testada indiretamente; criar/editar/excluir e o bloqueio de autoexclusão não têm teste.',
            ],
            [
                'area' => 'Cadastros',
            ...
            [
                ...
                'source' => ['app/Http/Controllers/Admin/ContractController.php'],
                'tests' => [],
                'note' => 'index/create/edit/show, update e attachWitness/markWitnessSigned não têm teste.',
            ],
            [
                'area' => 'Contratos',
            ...
            [
                ...
                'source' => ['app/Http/Controllers/Admin/ChargeController.php'],
                'tests' => [],
                'note' => 'A lógica interna (ChargeScheduler) é testada, mas a rota/policy/toast do botão não.',
            ],
            [
                'area' => 'Cobrança',
                ...
                'source' => ['app/Http/Controllers/Admin/ChargeController.php'],
                'tests' => ['tests/Feature/MercadoPagoOrdersTest.php'],
                'note' => 'Sincronizar pagamento via rota HTTP não tem teste; criar Pix só tem os casos de erro cobertos na rota.',
            ],
            [
                'area' => 'Cobrança',
                ...
                'tests' => [],
                'note' => 'Nem a rota nem a lógica de conteúdo do lembrete (antes/no dia/depois do vencimento) têm teste — só a confirmação de pagamento é testada.',
            ],
            [
                'area' => 'Cobrança',
            ...
            [
                ...
                'tests' => [],
                'note' => 'Nenhum teste cobre a varredura, as janelas de reenvio ou o lembrete de contrato vencendo.',
            ],
            [
                'area' => 'Cobrança',
            ...
            [
                ...
                'source' => ['app/Http/Controllers/Admin/DepositController.php'],
                'tests' => [],
                'note' => 'Só store/refund têm teste; update/destroy/createPix/syncPayment via HTTP não.',
            ],
            [
                'area' => 'Cobrança',
            ...
            [
                ...
                'note' => 'Só a criação com divisão por moradores é testada; atualizar, excluir, comprovante, divisão igual e o bloqueio de rateio já pago não têm teste.',
            ],
            [
                'area' => 'Cobrança',
                ...
                'tests' => [],
                'note' => 'Nenhum teste de rota — a policy e a validação de upload de comprovante não são exercitadas.',
            ],
            [
                'area' => 'Cobrança',
