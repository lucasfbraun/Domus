 ...
 *
 * Not scheduled by default. Add to routes/console.php to enable it:
 *   Schedule::job(new SyncPendingPixPaymentsJob)->everyFiveMinutes();
 */
class SyncPendingPixPaymentsJob implements ShouldQueue
{
    use Queueable;

    public function handle(MercadoPagoService $mercadoPago, ReminderService $reminderService): void
    {
        Charge::query()
