...
**Usuário (User)**:
Conta de autenticação do sistema, com um papel: Admin, Inquilino ou Recebedor. Um Inquilino ou um Recebedor pode estar vinculado a um Usuário para acessar seu próprio portal.
...
**Proprietário (Owner)**:
Dono de um Imóvel. Um Imóvel pode ter mais de um Proprietário. Proprietário nunca tem Usuário nem login próprio — é só um cadastro administrativo.
